function App(){
    ...
    let merge02 = arr01.concat(arr02);                  // concat : 2개 이상의 배열을 합쳐준다
    ...
    let arr04 =['복숭아','키위'];
     ...
     console.log('점 기호 3개(...)는 해당 배열 요소를 쭈욱 풀어 헤치는 역할을 합니다.');
    ...
    let [food01, food02, food03 = 'nofood', ...others] = arr05 ;  // others는 나머지 뒤에 3개 출력
    ...
    const myCarInfo = {...myCar, ...myUpdateCar};   // 두개의 객체를 하나의 객체로 합치려고 할떄 ... 
