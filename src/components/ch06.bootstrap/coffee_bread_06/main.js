...
function App(){
    ...
    const message = '카운터에서 주문해 주시고, 즐거운 시간 되시길 바랍니다.';
      ...
      // 신규 상품을 추가해야 하므로 setProducts가 이제 필요합니다.
...
//    /* 스테이트 CurrentProduct는 수정하고자 하는 상품 1개의 정보를 저장하기 위하여 정의 합니다.   */
...
//    const [newItem, setNewItem] = useState(null);
   ...
   */
   ...
   const InsertCategory = (formData) => {
        ...
        // 파라미터 이름은 파일 CreateCategory.js 에서 참조해야 합니다.
   ...
   /* 정렬 기능 추가 */
   /* 기본 정렬 방식으로 name 컬럼으로 오름차순으로 정렬할게요. */
   ...
   /* 사용자가 '정렬할 컬럼'또는 '정렬 방식'을 선택하면 여기로 코드가 실행됩니다.  */
